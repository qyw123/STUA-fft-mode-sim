...
# Flags
DEBUG_FLAGS = -O0 -Wall -Wno-unused-variable
...
TARGET = main
SRC = testbench.cpp FFT_initiator.cpp \
...
#       src/vcore/GEMM_SA/src/FIFO.cpp \
#       src/vcore/GEMM_SA/src/GEMM_TLM_pp.cpp \
#       src/vcore/GEMM_SA/src/PEA.cpp \
#       src/vcore/GEMM_SA/src/in_buf_vec.cpp \
#       src/vcore/GEMM_SA/src/out_buf_vec.cpp \
#       src/vcore/GEMM_SA/src/pe.cpp
